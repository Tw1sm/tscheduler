...
def main(
    ...
    task:               str     = typer.Option(None, '-t', '--task', help='Full path of the task or folder [Example: \Microsoft\Windows\MyTask]'),
    folder:             bool    = typer.Option(False, '--folder', help='The specified task path is a folder and not a task'),
    all:                bool    = typer.Option(False, '--all', help='Enumerate all tasks and folders on the target'),
    json:               bool    = typer.Option(False, '--json', help='Return the task configs as JSON instead of XML'),
